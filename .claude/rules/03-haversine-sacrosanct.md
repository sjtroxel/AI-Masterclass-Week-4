...
Never replace, remove, or externalize the Haversine utility (`server/utils/haversine.js`). It must remain:

- A standalone pure function with no external dependencies
- Covered by unit tests in `server/utils/haversine.test.js`
